...
public class CustomListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        if (this.imageLoader == null) {
            this.imageLoader = AppContoller.getInstance().getImageLoader();
        }
        ...
        ((RelativeLayout) convertView.findViewById(R.id.asser)).setOnClickListener(new View.OnClickListener() {
            @Override
